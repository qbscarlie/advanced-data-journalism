...
def get_html(ward):
    '''
    This should return the HTML of the Chicago precinct
    results page, by ward. You'll notice that the
    function takes an argument, called ward.
    This is an integer used to specify which ward the results
...
def get_table(html):
    '''
    This should return the HTML of the table on the page,
    which you can find using BeautifulSoup. The function
    takes the HTML of the page as input, so your job is
    to take that HTML, process it using BeautifulSoup,
